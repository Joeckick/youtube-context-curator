...
from config import CHANNELS, validate_config, ANTHROPIC_API_KEY, OPENAI_API_KEY, AI_PROVIDER
from youtube import get_all_new_videos, Video
from analysis import analyse_videos, analyse_video, get_anthropic_credit_balance, Analysis
from email_sender import send_digest, compose_digest_html
...
def run_demo() -> int:
    ...
    if not ANTHROPIC_API_KEY and not OPENAI_API_KEY:
        ...
        logger.error("Set ANTHROPIC_API_KEY (console.anthropic.com) or OPENAI_API_KEY (platform.openai.com)")
        return 1
